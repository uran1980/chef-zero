...
module ChefZero
  class RackApp
    ...
    def call(env)
      ...
      # Puma and WEBRick expect the response to be an array (chunked
      # responses). Since we are statically generating data, we won't ever
      # have said chunked response, so fake it.
